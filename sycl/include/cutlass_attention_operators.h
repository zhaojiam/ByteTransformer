  ...
  cutlass::gemm::GemmCoord operator()(int problem_idx) const {
    int valid_seqlen =
        seqlen_offsets_ == nullptr
            ? seqlen_
            /*
            DPCT1098:385: The '*' expression is used instead of the __ldg call. These two
            ...
            */
            : seqlen_offsets_[problem_idx + 1] -
                  /*
                  DPCT1098:386: The '*' expression is used instead of the __ldg call. These two
 ...
 public:
  ...
  cutlass::contrib::TensorParams<Element> operator()(int problem_idx, int batch_idx) const {
    ...
    if (seqlen_offsets_ == nullptr) {
      ...
      // remove padding
      /*
      DPCT1098:387: The '*' expression is used instead of the __ldg call. These two expressions do
...
class SoftmaxPartialEpilogueOp {
 ...
 public:
  ...
  /*
  DPCT1110:188: The total declared local variable size in device function operator() exceeds 128
...
void softmax_reduction_kernel(const T *buf, const int *seqlen_offsets, T *out,
  ...
  const int valid_seqlen =
      is_remove_padding
          /*
          DPCT1098:388: The '*' expression is used instead of the __ldg call. These two expressions
  ...
  if (row_idx < valid_seqlen) {
    ...
    /*
    DPCT1098:389: The '*' expression is used instead of the __ldg call. These two expressions do
    not provide the exact same functionality. Check the generated code for potential precision
    and/or performance issues.
    */
    max_val = *row_buf;
    for (int i = 1; i < valid_column; ++i) {
      /*
      DPCT1098:390: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
    ...
    for (int i = 0; i < valid_column; ++i) {
      /*
      DPCT1098:391: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
...
void softmax_reduction_kernel_launcher(const T *buf, const int *seqlen_offsets, T *out,
  ...
  assert(seq_len <= 1024);
  /*
  DPCT1049:189: The work-group size passed to the SYCL kernel may exceed the limit. To get the

...
void add_bias_input<float>(float *out, const float *input, const float *bias, int n,
  ...
  for (int i = item_ct1.get_local_id(2); i < n; i += item_ct1.get_local_range(2)) {
    int index = offset + i;
    /*
    DPCT1098:490: The '*' expression is used instead of the __ldg call. These two expressions do
...
void add_bias_input<sycl::half>(sycl::half *out, const sycl::half *input, const sycl::half *bias,
  ...
  out_ptr[id] =
      /*
      DPCT1098:491: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
      /*
      DPCT1064:492: Migrated __ldg call is used in a macro/template definition and may not be valid
...
void add_bias_input_restore_output<float>(const float *out, const float *input,
  ...
  /*
  DPCT1098:493: The '*' expression is used instead of the __ldg call. These two expressions do not
  ...
  */
  ...
  /*
  DPCT1098:494: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  ...
  for (int i = item_ct1.get_local_id(2); i < n; i += item_ct1.get_local_range(2)) {
    ...
    /*
    DPCT1098:495: The '*' expression is used instead of the __ldg call. These two expressions do
    not provide the exact same functionality. Check the generated code for potential precision
    and/or performance issues.
    */
...
void add_bias_input_restore_output<sycl::half>(const sycl::half *out, const sycl::half *input,
  ...
  const int seq_id = item_ct1.get_group(2) % seq_len;
  /*
  DPCT1098:496: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_offset = batch_idx[batch_id];
  /*
  DPCT1098:497: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_seq_len = batch_idx[batch_id + 1] - batch_offset;
...
void add_bias_half_input<float>(float *out, const float *input, const float *bias,
  ...
  for (int i = item_ct1.get_local_id(2); i < n; i += item_ct1.get_local_range(2)) {
    int index = offset + i;
    /*
    DPCT1098:500: The '*' expression is used instead of the __ldg call. These two expressions do
    not provide the exact same functionality. Check the generated code for potential precision
    and/or performance issues.
    */
...
void add_bias_half_input<sycl::half>(sycl::half *out, const sycl::half *input,
  ...
  out_ptr[id] =
      /*
      DPCT1098:501: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
...
void add_bias_half_input_restore_output<float>(const float *out, const float *input,
  ...
  const int seq_id = item_ct1.get_group(2) % seq_len;
  /*
  DPCT1098:506: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_offset = batch_idx[batch_id];
  /*
  DPCT1098:507: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_seq_len = batch_idx[batch_id + 1] - batch_offset;
  ...
  for (int i = item_ct1.get_local_id(2); i < n; i += item_ct1.get_local_range(2)) {
    int index = src_offset + i;
    /*
    DPCT1098:508: The '*' expression is used instead of the __ldg call. These two expressions do
    not provide the exact same functionality. Check the generated code for potential precision
    and/or performance issues.
    */
...
void add_bias_half_input_restore_output<sycl::half>(const sycl::half *out, const sycl::half *input,
  ...
  const int seq_id = item_ct1.get_group(2) % seq_len;
  /*
  DPCT1098:509: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_offset = batch_idx[batch_id];
  /*
  DPCT1098:510: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_seq_len = batch_idx[batch_id + 1] - batch_offset;
  ...
  ((sycl::half2 *)out2)[dst_offset] =
      /*
      DPCT1098:511: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */

...
void input_layernorm<float>(float *out, const float *input, const void *gamma,
  ...
  /*
  DPCT1098:442: The '*' expression is used instead of the __ldg call. These two expressions do not
...
void input_layernorm<sycl::half>(sycl::half *out, const sycl::half *input, const void *gamma,
  ...
  if (item_ct1.get_local_id(2) < n / 2)
    /*
    DPCT1098:443: The '*' expression is used instead of the __ldg call. These two expressions do
...
void input_compress_layernorm<float>(float *out, const float *input, const void *gamma,
                                                ...
                                                float *s_) {
  /*
  DPCT1098:444: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  ...
  /*
  DPCT1098:445: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
...
void input_compress_layernorm<sycl::half>(sycl::half *out, const sycl::half *input,
  ...
  /*
  DPCT1098:446: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  ...
  /*
  DPCT1098:447: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
...
void add_bias_input_layernorm<float>(float *out, const float *input, const float *bias,
  ...
  /*
  DPCT1098:448: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
...
void add_bias_input_layernorm<sycl::half>(sycl::half *out, const sycl::half *input,
  ...
  if (item_ct1.get_local_id(2) < n / 2)
    /*
    DPCT1098:449: The '*' expression is used instead of the __ldg call. These two expressions do
    not provide the exact same functionality. Check the generated code for potential precision
    and/or performance issues.
    */
...
void add_bias_input_layernorm_restore_output<float>(
  ...
  /*
  DPCT1098:452: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_offset = batch_idx[batch_id];
  /*
  DPCT1098:453: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  ...
  float local_out =
      /*
      DPCT1098:454: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
...
void add_bias_input_layernorm_restore_output<sycl::half>(
  ...
  const int seq_id = item_ct1.get_group(2) % seq_len;
  /*
  DPCT1098:455: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_offset = batch_idx[batch_id];
  /*
  DPCT1098:456: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_seq_len = batch_idx[batch_id + 1] - batch_offset;
...
void add_bias_input_out_layernorm<float>(float *out, const float *input,
  ...
  /*
  DPCT1098:460: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
...
void add_bias_input_out_layernorm<sycl::half>(sycl::half *out, const sycl::half *input,
  ...
  sycl::half2 local_out =
      /*
      DPCT1098:461: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
...
void add_bias_half_input_layernorm<float>(float *out, const float *input,
  ...
  /*
  DPCT1098:464: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
...
void add_bias_half_input_layernorm<sycl::half>(sycl::half *out, const sycl::half *input,
  ...
  sycl::half2 local_out =
      /*
      DPCT1098:465: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
      /*
      DPCT1064:467: Migrated __ldg call is used in a macro/template definition and may not be valid
      for all macro/template uses. Adjust the code.
      */
      /*
      DPCT1064:468: Migrated __hadd2 call is used in a macro/template definition and may not be
      valid for all macro/template uses. Adjust the code.
      */
      /*
      DPCT1064:469: Migrated __hmul2 call is used in a macro/template definition and may not be
      valid for all macro/template uses. Adjust the code.
      */
...
void add_bias_half_input_layernorm_restore_output<float>(
  ...
  const int seq_id = item_ct1.get_group(2) % seq_len;
  /*
  DPCT1098:470: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_offset = batch_idx[batch_id];
  /*
  DPCT1098:471: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_seq_len = batch_idx[batch_id + 1] - batch_offset;
  ...
  float local_out =
      /*
      DPCT1098:472: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
...
void add_bias_half_input_layernorm_restore_output<sycl::half>(
  ...
  const int seq_id = item_ct1.get_group(2) % seq_len;
  /*
  DPCT1098:473: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_offset = batch_idx[batch_id];
  /*
  DPCT1098:474: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  const int batch_seq_len = batch_idx[batch_id + 1] - batch_offset;
  ...
  /*
  DPCT1098:475: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  /*
  DPCT1064:479: Migrated __hadd2 call is used in a macro/template definition and may not be valid
  for all macro/template uses. Adjust the code.
  */
  /*
  DPCT1064:480: Migrated __hmul2 call is used in a macro/template definition and may not be valid
  for all macro/template uses. Adjust the code.
  */
  sycl::half2 local_out =
...
void add_bias_half_input_out_layernorm<float>(float *out, const float *input,
  ...
  /*
  DPCT1098:481: The '*' expression is used instead of the __ldg call. These two expressions do not
  provide the exact same functionality. Check the generated code for potential precision and/or
  performance issues.
  */
  float local_out = (out[offset] + bias[item_ct1.get_local_id(2)]) * 0.5f + input[offset];
...
void add_bias_half_input_out_layernorm<sycl::half>(sycl::half *out, const sycl::half *input,
  ...
  sycl::half2 local_out =
      /*
      DPCT1098:482: The '*' expression is used instead of the __ldg call. These two expressions do
      not provide the exact same functionality. Check the generated code for potential precision
      and/or performance issues.
      */
      /*
      DPCT1064:484: Migrated __ldg call is used in a macro/template definition and may not be valid
      for all macro/template uses. Adjust the code.
      */
      /*
      DPCT1064:485: Migrated __hadd2 call is used in a macro/template definition and may not be
      valid for all macro/template uses. Adjust the code.
      */
      /*
      DPCT1064:486: Migrated __hmul2 call is used in a macro/template definition and may not be
      valid for all macro/template uses. Adjust the code.
      */
      ((sycl::half2 *)out)[offset] +
      ((const sycl::half2 *)bias)[item_ct1.get_local_id(2)] * sycl::half2(0.5f, 0.5f) +
